...
@section('title', 'Read RSS feeds while offline, in the sun - ReaderFeeder')
...
@section('content')
  ...
  <div class="section features">
    <div class="container">
      <h2 id="features" class="text-center mb-0">Features</h2>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-5 offset-lg-1">
          ...
          <h3 class="font-family-base h6 mt-4 mb-3">Distraction-free reading</h3>
          <p>
        ...
        <div class="col-md-6 col-lg-5">
          ...
          <h3 class="font-family-base h6 mt-4 mb-3">Helps your eyes relax</h3>
          <p>
      ...
      <div class="row mt-5">
        <div class="col-md-6 col-lg-5 offset-lg-1">
          ...
          <h3 class="font-family-base h6 mt-4 mb-3">Full-text content</h3>
          <p>
        ...
        <div class="col-md-6 col-lg-5">
          ...
          <h3 class="font-family-base h6 mt-4 mb-3">Wireless delivery</h3>
          <p>
  ...
  <div class="section mt-5 mt-md-8 pricing">
    <div class="container">
      <h2 id="pricing" class="text-center mb-5 mb-lg-7">Pricing</h2>
  ...
  <div class="section section-cta text-center mb-6">
    <div class="container">
      <h2 class="section__title">Get started with ReaderFeeder today</h2>
      <p class="mt-4"><a class="btn btn-lg btn-lg-cta" href="/app/">Try it free</a></p>
